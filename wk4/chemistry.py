#Author JohnRusselle Domingo
#Date :OCT10_2024
#modfied : OCT13_2024
#revision 2

from formula import parse_formula
#1 modify from list to dict
#2 return the list instead of using loop
#3 insert compute molar mass function
#4 compute molar mass using formula
#5 update main method based on requirements
#6 download test_chemestry_2.py
#7 modify/tweek to pass the test
#8 Review Call graph
#9 improve

def make_periodic_table():
    periodic_table_dict  = {
    # symbo: [name, atomic_mass]
        "Ac":["Actinium",	227 ],
        "Ag":["Silver",	107.8682],
...
def main():
    ...
    mass_in_grams = float(input("Enter the mass of the chemical sample in grams: "))
    ...
    print(f"Molar mass of the molecule: {molar_mass:.2f} g/mol")
    
    # Print the number of moles
    print(f"Number of moles in the sample: {number_of_moles:.4f} mol")
