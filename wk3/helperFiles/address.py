...
print(extract_state("525 S Center St, Rexburg, ID 83460"))
print(extract_zipcode("525 S Center St, Rexburg, ID 83460"))
print(extract_city("525 S Center St, Rexburg, ID 83460"))